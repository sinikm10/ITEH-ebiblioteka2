...
if(isset($_POST['Unesi'])){
    ...
    $Kontakt = trim($_POST['telefon']);

    $uspesno = $db->Unesiclana($Ime,$Adresa, $Email,$Kontakt);

    if($uspesno){

        $poruka= "Uspesno ste uneli novog clana";
    }else{
         ...
         <div class="container">
            ...
            <div class="row product_section">
                <form method="post" action="">
                    ...
                    <input type="text" id="Imeprezime" name="Imeprezime" class="form-control">
                    ...
                    <br>
                    <input type="submit" class="btn btn-success" value="Unesi clana" name="Unesi">
                </form>
            </div>
          </div>
          <br><br>
